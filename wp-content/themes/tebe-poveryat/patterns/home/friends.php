<?php
/**
 * Title: Секция Друзья / Партнеры
 * Slug: tebe-poveryat/friends
 * Categories: teamwork
 * Description: Блок с логотипами или ссылками на партнеров.
 */
?>
...
<div class="wp-block-group alignwide" style="padding-top:60px;padding-bottom:60px">
    ...
    <h2 class="wp-block-heading has-text-align-center">Наши друзья и партнеры</h2>
    <!-- /wp:heading -->
    <!-- wp:paragraph {"align":"center"} -->
    <p class="has-text-align-center">Мы гордимся сотрудничеством!</p>
    <!-- /wp:paragraph -->
