...
<section class="projects-section w-full bg-peach relative overflow-hidden z-10 mt-[-40px] mb-[-40px] lg:mt-[-80px] lg:mb-[-80px] pt-[80px] lg:pt-[160px] pb-[80px] lg:pb-[160px]">
    ...
    <div class="projects__container container mx-auto px-4 relative z-20 flex flex-col items-start sm:items-center pt-[80px] pb-8 lg:pt-14 lg:pb-8">
        <h2 class="projects__title text-h2 text-primary font-ura uppercase text-left sm:text-center mb-4 lg:text-[64px] lg:leading-[0.95] lg:mb-[25px]">
            КАМПАНИЯ</h2>
        ...
        <div class="projects__content flex flex-col items-start sm:items-center gap-4 lg:gap-2 lg:max-w-[692px]">
            ...
            <div class="projects__description text-contrast text-[16px] font-geologica font-light leading-[1.5] text-left sm:text-center flex flex-col gap-2 lg:gap-2.5">
                <p class="sm:text-[23px]">Ежегодная акция ко Дню защиты детей, которую проводит «Тебе поверят».</p>
                <p class="sm:text-[23px]">Каждый год мы говорим о разных сторонах одной темы — как защитить детей от
                    сексуализированного насилия и как поддержать тех, кто его пережил.</p>
                <p class="sm:text-[23px]">Акция помогает обществу слышать, верить и поддерживать детей, делая шаги к
