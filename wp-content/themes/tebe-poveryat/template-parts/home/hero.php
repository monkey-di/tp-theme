        ...
        <div class="hero__slider swiper w-full flex-grow">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide flex flex-col justify-start items-start h-full">
                    ...
                    <!-- Decorative Image -->
                    <img class="hero__decor-image size-[98.73px] absolute top-[38px] right-4 origin-top-left rotate-[10deg] outline outline-[6px] outline-offset-[-3px] outline-secondary" src="https://www.figma.com/api/mcp/asset/b340971d-eb72-4eb3-88f4-0b125aaa4649" alt="Декоративное изображение" />
                ...
                <div class="swiper-slide flex flex-col justify-start items-start h-full">
                    ...
                    <img class="hero__decor-image size-[98.73px] absolute top-[38px] right-4 origin-top-left rotate-[10deg] outline outline-[6px] outline-offset-[-3px] outline-secondary" src="https://www.figma.com/api/mcp/asset/b340971d-eb72-4eb3-88f4-0b125aaa4649" alt="Декоративное изображение" />
                    <h2 class="hero__subtitle text-contrast text-4xl font-extrabold font-akrobat leading-9 mt-6">Вторая некоммерческая благотворительная организация</h2>
                    <div class="hero__description mt-6">
                ...
                <div class="swiper-slide flex flex-col justify-start items-start h-full">
                    ...
                    <img class="hero__decor-image size-[98.73px] absolute top-[38px] right-4 origin-top-left rotate-[10deg] outline outline-[6px] outline-offset-[-3px] outline-secondary" src="https://www.figma.com/api/mcp/asset/b340971d-eb72-4eb3-88f4-0b125aaa4649" alt="Декоративное изображение" />
                    <h2 class="hero__subtitle text-contrast text-4xl font-extrabold font-akrobat leading-9 mt-6">Третья некоммерческая благотворительная организация</h2>
                    <div class="hero__description mt-6">
