...
?>
<section
        class="about-section-part2 w-full bg-surface px-4 relative overflow-hidden z-20 pt-0 pb-12 lg:pb-32 [border-radius:0_0_50%_50%_/_0_0_40px_40px] lg:[border-radius:0_0_50%_50%_/_0_0_80px_80px]">
        ...
        if ($image_url) : ?>
            <div class="about-section-part2__image-wrapper">
                ...
                <div class="about-section-part2__overlay-text lg:hidden absolute left-0 bottom-4 w-full px-4 text-white">
                    <?php
                    if ($name) : ?>
                        <h3 class="text-h3 font-extrabold font-akrobat uppercase leading-10 mb-0"><?php
                            echo esc_html($name); ?></h3>
                    <?php
                    endif; ?>
                    <?php
                    if ($position) : ?>
                        <p class="text-[16px] font-normal font-geologica leading-[1.5]"><?php
                            echo esc_html($position); ?></p>
                    <?php
                    endif; ?>
                </div>
            </div>
        ...
        <div class="w-full lg:w-auto flex flex-col gap-8 md:gap-1 mt-6 lg:mt-0">
            ...
            if ($name || $position) : ?>
                <div class="hidden lg:block">
                    <?php
                    if ($name) : ?>
                        <h3 class="text-[40px] font-extrabold font-akrobat uppercase leading-none"><?php
                            echo esc_html($name); ?></h3>
                    <?php
                    endif; ?>
                    <?php
                    if ($position) : ?>
                        <p class="text-[20px] font-light font-geologica"><?php
                            echo esc_html($position); ?></p>
                    <?php
                    endif; ?>
                </div>
