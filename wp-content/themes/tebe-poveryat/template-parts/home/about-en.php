        ...
        <div class="w-full  flex-[2.5]">
            ...
            <div class="about-en__impact mt-12 lg:mt-0 xl:pl-[66px]">
                ...
                <div class="about-en__stats">
                    <!-- Card 1: Years -->
                    <div class="about-en__stat-card bg-primary">
                        <div class="about-en__stat-number">6</div>
                        <p class="about-en__stat-text">years of dedicated work</p>
                    </div>

                    <!-- Card 2: Consultations -->
                    <div class="about-en__stat-card bg-teal">
                        <div class="about-en__stat-number">8 228</div>
                        <p class="about-en__stat-text">consultations held with survivors and families</p>
                    </div>

                    <!-- Card 3: People -->
                    <div class="about-en__stat-card bg-sky">
                        <div class="about-en__stat-number">2 091</div>
                        <p class="about-en__stat-text">people received psychological and legal support</p>
                    </div>

                    <!-- Card 4: Team -->
                    <div class="about-en__stat-card bg-peach">
