...
-->
<div class="slider-progress relative w-full h-[2px] overflow-hidden rounded-[4px] <?php echo esc_attr($track_color . ' ' . $class); ?> 
    [&.swiper-pagination-progressbar]:!relative 
    [&.swiper-pagination-progressbar]:!bg-white 
    [&_.swiper-pagination-progressbar-fill]:!bg-secondary  
