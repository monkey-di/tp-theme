...
<main class="site-main blog-page">
    <div class="page-head z-20 bg-surface relative [border-radius:0_0_50%_50%_/_0_0_40px_40px] lg:[border-radius:0_0_50%_50%_/_0_0_80px_80px]"<?php if(<?php if($pagehead_bg_image != ''){?> != ''){?> style="background:<?=$pagehead_bg_color?>" <?php } ?>>
