...
<header class="header w-full bg-surface relative z-50">
  <div class="header__container mx-auto px-4 xl:px-24 flex justify-between items-center h-[144px] xl:h-[80px]">
    ...
    <!-- Logo Wrapper -->
    <a href="<?php echo home_url(); ?>" class="header__logo-link flex items-center gap-[16px] flex-shrink-0 no-underline">
      <!-- Mobile Logo (Icon only) -->
      <div class="header__logo-mobile xl:hidden flex-shrink-0 w-[67px] h-[64px]">
        <?php
        if ( has_custom_logo() ) {
            the_custom_logo();
        } else {
      ...
      <div class="header__logo-desktop hidden xl:flex items-center gap-[16px] flex-shrink-0">
        ...
        <div class="header__logo-icon flex-shrink-0 w-[60px] h-[64px]">
          <img src="https://www.figma.com/api/mcp/asset/b490df65-48d5-4c98-9b5c-d01ff681a977" alt="Logo Icon" class="w-full h-full object-contain" />
        </div>

        <!-- Logo Text -->
        <div class="header__logo-text flex-shrink-0 w-[164.905px] h-[16px]">
          <img src="https://www.figma.com/api/mcp/asset/a1f71fdd-4bd7-47e7-871a-527f3538e3ac" alt="Tebe Poveryat" class="w-full h-full object-contain" />
        </div>
      </div>
    </a>

    <!-- Desktop Navigation Menu (hidden on mobile) -->
    <nav class="header__nav hidden xl:flex items-center gap-[32px] flex-1 justify-center">
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">О проблеме</a>
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">Для переживших</a>
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">Как мы помогаем</a>
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">Проекты</a>
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">О нас</a>
      <a href="#" class="header__nav-link text-contrast font-akrobat font-bold text-[20px] leading-none hover:text-primary transition">Блог</a>
    </nav>
    ...
    <div class="header__controls hidden xl:flex items-center gap-[24px]">
      ...
      <!-- Donate Button -->
      <a href="#" class="header__donate-btn bg-secondary rounded-[40px] px-[20px] py-[8px] h-[60px] flex items-center gap-[8px] no-underline hover:opacity-90 transition">
        <div class="header__donate-icon w-[20px] h-[18px] flex items-center justify-center flex-shrink-0">
          <svg width="20" height="18" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
    ...
    <a href="#" class="header__donate-btn-mobile xl:hidden w-[159px] h-10 px-3 py-2 bg-secondary rounded-[40px] flex justify-center items-center gap-1 no-underline hover:opacity-90 transition">
