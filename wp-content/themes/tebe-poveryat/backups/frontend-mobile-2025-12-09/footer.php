...
<footer class="footer w-full bg-primary relative overflow-hidden py-12 lg:py-[56px] px-4">
    ...
    <div class="footer__container container mx-auto px-4 relative z-20 flex flex-col lg:flex-row lg:justify-between gap-8 lg:gap-12">

        <!-- Left Column -->
        <div class="footer__left flex flex-col gap-8 lg:gap-6 items-center lg:items-start lg:w-[40%]">

            <!-- Logo -->
            <div class="footer__logo">
                 <a href="<?php echo home_url(); ?>" class="block w-[348px] lg:w-[573px] h-[84px] lg:h-[138px]">
                     <img src="https://www.figma.com/api/mcp/asset/802942f5-abc3-4669-879e-3ee57d459253" alt="<?php echo get_bloginfo( 'name' ); ?>" class="w-full h-full object-contain lg:object-left" />
                 </a>
            </div>

            <!-- Social Icons -->
            <div class="footer__social flex gap-4 lg:gap-3 justify-center lg:justify-start">
            ...
            <!-- Contact Email -->
            <a href="mailto:verimtebe@gmail.com" class="footer__email text-white text-[32px] font-extrabold font-akrobat uppercase leading-none no-underline hover:underline text-center lg:text-left">
                verimtebe@gmail.com
            </a>

            <!-- Copyright -->
            <div class="footer__copyright hidden lg:block text-white text-[14px] font-light font-geologica leading-[1.5]">© «Тебе поверят», 2025</div>
        ...
        <!-- Right Column -->
        <div class="footer__right flex flex-col gap-8 lg:gap-6 lg:w-[55%] lg:max-w-[692px]">

            <!-- Navigation Links -->
            <div class="footer__nav flex flex-col lg:flex-row gap-2 lg:gap-6">
                <?php get_template_part('template-parts/components/button', null, ['text' => 'Проекты', 'url' => '#', 'style' => 'outline-white', 'class' => 'w-full lg:flex-1', 'size' => 'md']); ?>
                <?php get_template_part('template-parts/components/button', null, ['text' => 'Отчеты', 'url' => '#', 'style' => 'outline-white', 'class' => 'w-full lg:flex-1', 'size' => 'md']); ?>
                <?php get_template_part('template-parts/components/button', null, ['text' => 'О нас', 'url' => '#', 'style' => 'outline-white', 'class' => 'w-full lg:flex-1', 'size' => 'md']); ?>
                <?php get_template_part('template-parts/components/button', null, ['text' => 'Реквизиты', 'url' => '#', 'style' => 'outline-white', 'class' => 'w-full lg:flex-1', 'size' => 'md']); ?>
            </div>
        ...
        <div class="footer__mobile-bottom lg:hidden flex flex-col gap-4 mt-4">
            <!-- Copyright -->
            <div class="footer__copyright text-white text-[14px] font-light font-geologica leading-[1.5] text-center">© «Тебе поверят», 2025</div>

            <!-- Author Signature -->
            <div class="footer__author flex justify-center">
                <img src="https://www.figma.com/api/mcp/asset/734dba62-15fd-4cd2-8028-ca94fbc94bfe" alt="Made with Love" class="w-[186px] h-[20px] object-contain opacity-100" />
            </div>
        </div>
