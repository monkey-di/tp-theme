...
<header class="header w-full bg-base relative z-50">
  <div class="header__container container mx-auto px-4 flex justify-between items-center h-[144px]"> <!-- Height from Frame 13 -->
    ...
    <!-- Donate Button -->
    <a href="#" class="header__donate-btn w-[159px] h-10 px-3 py-2 bg-secondary rounded-[40px] flex justify-center items-center gap-1 no-underline hover:opacity-90 transition mx-auto">
