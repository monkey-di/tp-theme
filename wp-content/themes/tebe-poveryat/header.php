...
<header class="header w-full bg-surface relative z-50">
    <div class="header__container mx-auto px-4 xl:px-24 flex justify-between items-center h-[144px] xl:h-[80px]">
        ...
        echo home_url(); ?>" class="header__logo-link flex items-center gap-[16px] flex-shrink-0 no-underline">
            ...
            <div class="header__logo-desktop hidden xl:flex items-center gap-[16px] flex-shrink-0">
                ...
                <div class="header__logo-icon flex-shrink-0 w-[60px] h-[64px]">
                    <img src="<?php echo get_theme_file_uri('assets/images/logo-header-icon.svg'); ?>" alt="Logo Icon"
                         class="w-full h-full object-contain"/>
                </div>
        ...
        <div class="header__controls hidden xl:flex items-center gap-[24px]">
            ...
            <!-- Donate Button -->
            <a href="#"
               class="header__donate-btn bg-secondary rounded-[40px] px-[20px] py-[8px] h-[60px] flex items-center gap-[8px] no-underline hover:opacity-90 transition">
        ...
        <a href="#"
           class="header__donate-btn-mobile xl:hidden w-[159px] h-10 px-3 py-2 bg-secondary rounded-[40px] flex justify-center items-center gap-1 no-underline hover:opacity-90 transition">
